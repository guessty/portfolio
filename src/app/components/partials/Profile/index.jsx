  ...
  render() {
    return (
      <Flex className="gap-between-2">
        <p>I am a mid-level front end developer with 5 years of commercial experience (3 years using ReactJS).</p>
        ...
        <p>
          I am detail-oriented and value any process that improves the quality of a codebase, such as well defined coding standards, type checking, and peer reviews,
          I always ensure my code is cleanly written, appropriately documented, fully tested, and focused on reusability.
        </p>
